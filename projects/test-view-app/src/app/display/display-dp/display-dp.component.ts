...
export class DisplayDpComponent {
  ...
  public snippet1: CompackCodeSnippetModel[] = [new CompackCodeSnippetModel(
    'html',
    `<compack-date-picker [rangeMode]="rangeMode" [disabled]="disabled" [setDateEvent]="setDateEvent"
  ...
  public snippet4: CompackCodeSnippetModel[] = [new CompackCodeSnippetModel(
    ...
    [setDateEvent]="setDateEvent" [viewFieldSelectedDate]="viewFieldSelectedDate" [formatOutputDate]="format"
    [useTime]="useTime" [maxChoseDay]="maxChoseDay" [locale]="locale" [max]="max" [min]="min"
    [autoSelect]="autoSelect" (selectLastDateEvent)="selectDateEvent($event)">
  ...
  public snippet2222: CompackCodeSnippetModel[] = [new CompackCodeSnippetModel('html', '')];
  ...
  public onTest() {
    ...
    this.snippet2222 = [new CompackCodeSnippetModel('html2', html)]
  }
